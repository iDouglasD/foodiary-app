...
export function MealCard({ name }: MealCardProps) {
  ...
  return (
    <TouchableOpacity>
      <Text className="text-base font-sans-regular text-gray-700">Hoje, 12h15</Text>
      <View className="mt-2 px-4 py-5 flex-row gap-3 items-center border border-gray-400 rounded-xl">
